                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body ">
                            ...
                            <div class=" row col-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                    ...
                                    <p class="te-modal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto vero quos quidem
                                        nobis sed earum
                        ...
                        <div class="modal-footer" style={{display: "flex", justifyContent: "center"}}>
                            <div class="modal-but-ajuda">
                                ...
                                <div class="dicaTexto">Esta é a área para personalizar quais exercícios deseja fazer ou não. Você pode
                ...
                <div class="row m-0 row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <a href="" className="linkreact">
                            ...
                            <div class="card h-100 bg-light ho-bor" style={{position: "static"}}>
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text textos" style={{textAlign: "justify"}}>Lorem, ipsum dolor sit amet consectetur
