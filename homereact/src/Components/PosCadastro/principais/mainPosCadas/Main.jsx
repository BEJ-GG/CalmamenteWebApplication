...
import { faQuestionCircle, faRobot, faUserEdit } from "@fortawesome/free-solid-svg-icons";
                ...
                <Nav className="">
                    ...
                    <div className="perfi-usu">
                        ...
                        <div className="per-text" id="bt-quaper">
                            <a href="#"><FontAwesomeIcon icon={faUserEdit} className="fas ic-modal i-per-fil linkreact" style={{ color: "black" }}/></a>
                            <FontAwesomeIcon icon={faQuestionCircle} className="fas i-imusu"/>
                            ...
                            <a href="#" className="linkreact">
                                <div className=" per-falabo">
                                    ...
                                    <FontAwesomeIcon icon={faRobot} className="fas  ic-bot-per ic-fabo"/>
                                </div>
                            </a>
