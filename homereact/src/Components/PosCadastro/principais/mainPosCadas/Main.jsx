...
import Origami from '../../exercicios/origami/ExercicioOrgiami'
import ParadaRes from '../../exercicios/paradaPensamento/ExercicioParadaPensamento'
import ImaGuiada from '../../exercicios/imaginacaoGuiada/ExercicioImaginacaoGuiada'
                    ...
                    <Navbar collapseOnSelect expand="lg" variant="light" className="back-menu m-0 p-0 d-flex justify-content-between">
                        <div className="m-0 container-fluid ">
                            ...
                            <Navbar.Collapse className="justify-content-end" id="responsive-navbar-nav">
                                <Nav className="">
                                    <Link to="/imaguiada" className="menu-di  mx-1 linkreact">Estou em crise</Link>
    ...
    <!-- fim menu  --> */}
                    ...
                    <main>
                        <Switch>
                            ...
                            <Route path="/paradares" component={ParadaRes} />
                            <Route path="/imaguiada" component={ImaGuiada} />
