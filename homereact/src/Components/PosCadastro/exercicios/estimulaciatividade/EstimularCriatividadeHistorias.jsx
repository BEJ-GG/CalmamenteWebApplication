                            ...
                            <div class="col">
                                <a href="" class="linkreact">
                                    <div class="card h-100  ho-bor" >
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-center titulos">Café da manhã na savana</h5>
                                            <p class="card-text textos" style={{textAlign: 'justify'}}>O explorador está tomando um café reforçado junto com sua esposa e cachorro, pois hoje é um dia muito importante. Eles terminam de comer e partem na sua aventura, em busca de...</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="" class="linkreact">
                                    <div class="card h-100  ho-bor" >
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-center titulos">A ilha nas nuvens</h5>
                                            <p class="card-text textos" style={{textAlign: 'justify'}}>Seu avô já contava-lhe essa história desde que nasceu, a história de uma ilha nas nuvens, um lugar onde a maldade não existe e onde estão abrigados os últimos seres místicos do planeta, porém apenas um puro de coração poderia achar este local. E então quando o garoto fez 10 anos, desejou passar alguns dias no sítio de seu avô por uma semana como presente de aniversário. Chegando lá, o garoto se vira para o avô e lhe-faz a seguinte proposta... </p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col mrgb-pequena">
                                <a href="" class="linkreact">
                                    <div class="card h-100  ho-bor" >
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-center titulos">Julgamento da natureza</h5>
                                            <p class="card-text textos" style={{textAlign: 'justify'}}>Depois de anos da humanidade desmatando a natureza, acabando com as florestas e exterminando a fauna e a flora. Dois seres emergem do chão, utilizando em sua compozição os últimos resquícios de natureza do planeta. "Vocês são os culpados por toda essa dor e sofrimento!". E então os seres...</p>
                                        </div>
                                    </div>
                                </a>
                            </div>
                            <div class="col mrgb-pequena">
                                <a href="" class="linkreact">
                                    <div class="card h-100  ho-bor" >
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title d-flex justify-content-center titulos">O lendário Zebroceronte</h5>
                                            <p class="card-text textos" style={{textAlign: 'justify'}}>O zebroceronte é um animal lendário africano que foi avistado por um caçador em sua região, esse caçador espalhou boatos da criatura por todos os lugares e caçadores do mundo todo começaram a disputar para ver quem conseguia primeiro a cabeça do animal.
